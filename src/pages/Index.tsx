  ...
  return (
    <div className="min-h-screen bg-background font-vietnam">
      <Helmet>
        ...
        <meta name="description" content="LTH Chemistry — Thầy Lê Trung Hiếu dạy Hóa cấp 3 tại Hà Nội. 78% học sinh đạt từ 8 điểm Hóa, 92% đậu trường mục tiêu. Luyện thi THPTQG hiệu quả." />
