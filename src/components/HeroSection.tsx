        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left animate-fade-in">
            ...
            <p className="font-vietnam text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl">
              Phương pháp học Hóa học hiệu quả, được thiết kế đặc biệt cho học sinh cấp 3. 
              Cùng thầy Lê Trung Hiếu biến Hóa học từ khó khăn thành đam mê.
            </p>
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-3 gap-6 max-w-md mx-auto lg:mx-0">
              <div className="text-center">
                <div className="font-quicksand font-bold text-2xl gradient-text">90%+</div>
                <div className="font-vietnam text-sm text-muted-foreground">Học sinh đạt 8+</div>
              </div>
              <div className="text-center">
                <div className="font-quicksand font-bold text-2xl gradient-text">5+</div>
